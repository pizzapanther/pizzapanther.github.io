"""
Django settings for nnote project.
...
WSGI_APPLICATION = 'nnote.wsgi.application'
...
DATABASES = {
  'default': dj_database_url.config(default='postgres://postgres:postgres@localhost:5432/nnote')
}
